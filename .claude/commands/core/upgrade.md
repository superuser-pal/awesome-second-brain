...
**For `--dry-run`**: write the plan to `thinking/upgrade-plan-YYYY-MM-DD.md` and stop.
...
Migration complete.
  ...
  ⚠ 3 orphan notes (no inbound links) — run /audit to fix
...
Offer next steps:
- "Run `/audit` for a full structural check"
