...
Invoked by `/week-prep`. Creates a weekly plan file, selects committed tasks, and activates the week.
...
If one exists, warn:
> "Week W[x] is still active. Close it first with `/week-close`, or continue planning without closing?"
