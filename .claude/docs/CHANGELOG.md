...
### Added
- Vault-first memory system — all project memories live in `user/` (git-tracked), `MEMORY.md` becomes an index-only pointer
...
- `work/org/` — organizational knowledge (`work/org/people/`, `work/org/teams/`, `People & Context.md`)
- `reference/` — codebase knowledge and architecture docs
- `perf/evidence/` — PR deep scans for review prep
- `perf/wins/` — quarterly wins notes
...
- `perf/` — Wins Doc, Review Template, competencies/
