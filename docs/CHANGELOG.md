...
#### 27 Commands
Included out of the box are **27 tailored commands** mapping across Agent, Capture, Core, Manage, Review, and Rituals directories that execute specific, highly focused macro tasks securely within your file system. These include `/standup`, `/weekly`, `/humanize`, `/vault-upgrade`, `/dump`, and more.
