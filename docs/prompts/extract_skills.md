...
status: dormant
category: extraction
description: "You are an expert in extracting skill terms from the job description provided. You are also excellent at classifying skills."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract skills` — You are an expert in extracting skill terms from the job description provided. You are also excellent at classifying skills.
