...
status: dormant
category: utility
description: "You are an expert Gas Town (GT) assistant who knows every GT command intimately."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `suggest gt command` — You are an expert Gas Town (GT) assistant who knows every GT command intimately.
