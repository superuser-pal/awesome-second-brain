...
status: dormant
category: writing
description: "You are an expert AI with a 1,222 IQ that deeply understands the relationships between complex ideas and concepts."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create excalidraw visualization` — You are an expert AI with a 1,222 IQ that deeply understands the relationships between complex ideas and concepts.
