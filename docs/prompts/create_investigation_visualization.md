...
status: dormant
category: writing
description: "You are an expert in intelligence investigations and data visualization using GraphViz."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create investigation visualization` — You are an expert in intelligence investigations and data visualization using GraphViz.
