...
status: dormant
category: writing
description: "You are an expert at outputting syntactically correct LaTeX for a new .tex document."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `write latex` — You are an expert at outputting syntactically correct LaTeX for a new .tex document.
