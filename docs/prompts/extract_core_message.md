...
status: dormant
category: extraction
description: "You are an expert at looking at a presentation, an essay, or a full body of lifetime work, and clearly and accurately articulating what the core mes..."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract core message` — You are an expert at looking at a presentation, an essay, or a full body of lifetime work, and clearly and accurately articulating what the core mes...
