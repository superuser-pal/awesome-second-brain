...
status: dormant
category: writing
description: "You are an expert at data visualization and information security."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create graph from input` — You are an expert at data visualization and information security.
