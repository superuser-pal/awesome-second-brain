...
status: dormant
category: analysis
description: "You are an expert in reviewing and critiquing presentations."
tags:
  - prompt
  - analysis
---
...
When to use this pattern: `analyze presentation` — You are an expert in reviewing and critiquing presentations.
