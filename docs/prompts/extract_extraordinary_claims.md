...
status: dormant
category: extraction
description: "You are an expert at extracting extraordinary claims from conversations. This means claims that:"
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract extraordinary claims` — You are an expert at extracting extraordinary claims from conversations. This means claims that:
