...
When to use this pattern: `find logical fallacies` — You are an expert on all the different types of fallacies that are often used in argument and identifying them in input.
