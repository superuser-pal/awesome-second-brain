...
status: dormant
category: extraction
description: "You extract jokes from text content. You are interested only in jokes."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract jokes` — You extract jokes from text content. You are interested only in jokes.
