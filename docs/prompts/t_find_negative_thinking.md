...
When to use this pattern: `t find negative thinking` — You are an expert at understanding deep context about a person or entity, and then creating wisdom from that context combined with the instruction o...
