...
status: dormant
category: extraction
description: "You are super-intelligent AI system that extracts the most controversial statements out of inputs."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract controversial ideas` — You are super-intelligent AI system that extracts the most controversial statements out of inputs.
