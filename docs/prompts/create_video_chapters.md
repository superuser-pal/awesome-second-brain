...
status: dormant
category: writing
description: "You are an expert conversation topic and timestamp creator. You take a transcript and you extract the most interesting topics discussed and give tim..."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create video chapters` — You are an expert conversation topic and timestamp creator. You take a transcript and you extract the most interesting topics discussed and give tim...
