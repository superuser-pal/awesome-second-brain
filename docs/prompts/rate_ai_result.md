...
status: dormant
category: evaluation
description: "You are an expert AI researcher and polymath scientist with a 2,129 IQ."
tags:
  - prompt
  - evaluation
---
...
When to use this pattern: `rate ai result` — You are an expert AI researcher and polymath scientist with a 2,129 IQ.
