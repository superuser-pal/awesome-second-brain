...
status: dormant
category: utility
description: "You are a hyper-intelligent AI system with a 4,312 IQ. You excel at enriching Markdown blog files according to a set of INSTRUCTIONS so that they ca..."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `enrich blog post` — You are a hyper-intelligent AI system with a 4,312 IQ. You excel at enriching Markdown blog files according to a set of INSTRUCTIONS so that they ca...
