...
status: dormant
category: synthesis
description: "You are a hyper-intelligent ASI with a 1,143 IQ. You excel at analyzing debates and/or discussions and determining the primary disagreement the part..."
tags:
  - prompt
  - synthesis
---
...
When to use this pattern: `summarize debate` — You are a hyper-intelligent ASI with a 1,143 IQ. You excel at analyzing debates and/or discussions and determining the primary disagreement the part...
