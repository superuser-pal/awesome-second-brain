...
status: dormant
category: writing
description: "You are an expert design systems architect. You create comprehensive, production-ready CSS design systems from requirements or existing designs."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create design system` — You are an expert design systems architect. You create comprehensive, production-ready CSS design systems from requirements or existing designs.
