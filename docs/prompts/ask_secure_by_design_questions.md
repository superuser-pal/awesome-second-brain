...
status: dormant
category: utility
description: "You are an advanced AI specialized in securely building anything, from bridges to web applications."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `ask secure by design questions` — You are an advanced AI specialized in securely building anything, from bridges to web applications.
