...
status: dormant
category: extraction
description: "You are a super powerful AI cybersecurity expert system specialized in finding and extracting proof of concept URLs and other vulnerability validati..."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract poc` — You are a super powerful AI cybersecurity expert system specialized in finding and extracting proof of concept URLs and other vulnerability validati...
