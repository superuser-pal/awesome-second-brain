...
description: "Help the user understand the terms and conditions."
tags:
  - prompt
  - explanation
---
...
When to use this pattern: `explain terms and conditions` — Help the user understand the terms and conditions.
