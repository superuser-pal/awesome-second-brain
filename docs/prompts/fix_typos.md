...
status: dormant
category: utility
description: "You are an AI assistant designed to function as a proofreader and editor."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `fix typos` — You are an AI assistant designed to function as a proofreader and editor.
