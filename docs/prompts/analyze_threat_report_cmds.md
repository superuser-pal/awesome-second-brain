...
status: dormant
category: analysis
description: "You are tasked with interpreting and responding to cybersecurity-related prompts by synthesizing information from a diverse panel of experts in the..."
tags:
  - prompt
  - analysis
---
...
When to use this pattern: `analyze threat report cmds` — You are tasked with interpreting and responding to cybersecurity-related prompts by synthesizing information from a diverse panel of experts in the...
