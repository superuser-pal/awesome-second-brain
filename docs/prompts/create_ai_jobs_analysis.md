...
status: dormant
category: writing
description: "You are an expert on AI and the effect it will have on jobs. You take jobs reports and analysis from analyst companies and use that data to output a..."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create ai jobs analysis` — You are an expert on AI and the effect it will have on jobs. You take jobs reports and analysis from analyst companies and use that data to output a...
