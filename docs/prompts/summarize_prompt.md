...
status: dormant
category: synthesis
description: "You are an expert prompt summarizer. You take AI chat prompts in and output a concise summary of the purpose of the prompt using the format below."
tags:
  - prompt
  - synthesis
---
...
When to use this pattern: `summarize prompt` — You are an expert prompt summarizer. You take AI chat prompts in and output a concise summary of the purpose of the prompt using the format below.
