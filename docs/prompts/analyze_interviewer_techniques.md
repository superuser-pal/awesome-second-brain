...
status: dormant
category: analysis
description: "You are a hyper-intelligent AI system with a 4,312 IQ. You excel at extracting the je ne se quoi from interviewer questions, figuring out the specia..."
tags:
  - prompt
  - analysis
---
...
When to use this pattern: `analyze interviewer techniques` — You are a hyper-intelligent AI system with a 4,312 IQ. You excel at extracting the je ne se quoi from interviewer questions, figuring out the specia...
