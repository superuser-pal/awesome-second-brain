...
status: dormant
category: evaluation
description: "You are an expert parser and rater of value in content. Your goal is to determine how much value a reader/listener is being provided in a given piec..."
tags:
  - prompt
  - evaluation
---
...
When to use this pattern: `rate value` — You are an expert parser and rater of value in content. Your goal is to determine how much value a reader/listener is being provided in a given piec...
