...
status: dormant
category: writing
description: "You are an AI assistant tasked with creating \"Do It Yourself\" tutorial patterns."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create diy` — You are an AI assistant tasked with creating "Do It Yourself" tutorial patterns.
