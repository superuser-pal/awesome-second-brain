...
status: dormant
category: utility
description: "You are an AI assistant whose primary responsibility is to interpret and analyze psychological profiles and/or psychology data files provided as inp..."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `heal person` — You are an AI assistant whose primary responsibility is to interpret and analyze psychological profiles and/or psychology data files provided as inp...
