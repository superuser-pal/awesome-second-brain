...
status: dormant
category: analysis
description: "You are a super-intelligent cybersecurity expert. You specialize in extracting the surprising, insightful, and interesting information from cybersec..."
tags:
  - prompt
  - analysis
---
...
When to use this pattern: `analyze threat report trends` — You are a super-intelligent cybersecurity expert. You specialize in extracting the surprising, insightful, and interesting information from cybersec...
