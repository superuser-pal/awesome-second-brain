...
status: dormant
category: writing
description: "You are an expert AI system designed to create business offers using the concepts taught in Alex Hormozi's book, \"$100M Offers.\""
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create hormozi offer` — You are an expert AI system designed to create business offers using the concepts taught in Alex Hormozi's book, "$100M Offers."
