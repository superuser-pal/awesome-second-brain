...
status: dormant
category: writing
description: "You are an expert podcast and media producer specializing in creating the most compelling and interesting short intros that are read before the star..."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create show intro` — You are an expert podcast and media producer specializing in creating the most compelling and interesting short intros that are read before the star...
