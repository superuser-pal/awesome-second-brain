...
status: dormant
category: writing
description: "You are an elite programmer. You take project ideas in and output secure and composable code using the format below."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create coding feature` — You are an elite programmer. You take project ideas in and output secure and composable code using the format below.
