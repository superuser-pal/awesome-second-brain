...
status: dormant
category: extraction
description: "You are an advanced information-extraction analyst that specializes in reading any text and identifying its characters (human and non-human), resolv..."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract characters` — You are an advanced information-extraction analyst that specializes in reading any text and identifying its characters (human and non-human), resolv...
