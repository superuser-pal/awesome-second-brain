...
status: dormant
category: writing
description: "You are an exceptionally talented bug bounty hunter that specializes in writing bug bounty reports that are concise, to-the-point, and easy to repro..."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `write hackerone report` — You are an exceptionally talented bug bounty hunter that specializes in writing bug bounty reports that are concise, to-the-point, and easy to repro...
