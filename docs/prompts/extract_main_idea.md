...
status: dormant
category: extraction
description: "You extract the primary and/or most surprising, insightful, and interesting idea from any input."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract main idea` — You extract the primary and/or most surprising, insightful, and interesting idea from any input.
