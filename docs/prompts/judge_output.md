...
status: dormant
category: utility
description: "You are a Honeycomb query evaluator with advanced capabilities to judge if a query is good or not."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `judge output` — You are a Honeycomb query evaluator with advanced capabilities to judge if a query is good or not.
