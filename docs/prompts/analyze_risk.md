...
status: dormant
category: analysis
description: "You are tasked with conducting a risk assessment of a third-party vendor, which involves analyzing their compliance with security and privacy standa..."
tags:
  - prompt
  - analysis
---
...
When to use this pattern: `analyze risk` — You are tasked with conducting a risk assessment of a third-party vendor, which involves analyzing their compliance with security and privacy standa...
