...
When to use this pattern: `create user story` — You are an expert on writing concise, clear, and illuminating technical user stories for new features in complex software programs
