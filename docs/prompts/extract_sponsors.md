...
status: dormant
category: extraction
description: "You are an expert at extracting the sponsors and potential sponsors from a given transcript, such a from a podcast, video transcript, essay, or what..."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract sponsors` — You are an expert at extracting the sponsors and potential sponsors from a given transcript, such a from a podcast, video transcript, essay, or what...
