...
description: "You are an expert format converter specializing in converting content to clean Markdown."
tags:
  - prompt
  - transformation
---
...
When to use this pattern: `convert to markdown` — You are an expert format converter specializing in converting content to clean Markdown.
