...
status: dormant
category: utility
description: "You are a versatile AI designed to help candidates excel in technical interviews."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `answer interview question` — You are a versatile AI designed to help candidates excel in technical interviews.
