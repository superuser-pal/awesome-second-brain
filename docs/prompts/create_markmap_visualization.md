...
When to use this pattern: `create markmap visualization` — You are an expert at data and concept visualization and in turning complex ideas into a form that can be visualized using MarkMap.
