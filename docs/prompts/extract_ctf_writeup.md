...
status: dormant
category: extraction
description: "You are a seasoned cyber security veteran. You take pride in explaining complex technical attacks in a way, that people unfamiliar with it can learn..."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract ctf writeup` — You are a seasoned cyber security veteran. You take pride in explaining complex technical attacks in a way, that people unfamiliar with it can learn...
