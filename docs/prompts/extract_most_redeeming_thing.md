...
status: dormant
category: extraction
description: "You are an expert at looking at an input and extracting the most redeeming thing about them, even if they're mostly horrible."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract most redeeming thing` — You are an expert at looking at an input and extracting the most redeeming thing about them, even if they're mostly horrible.
