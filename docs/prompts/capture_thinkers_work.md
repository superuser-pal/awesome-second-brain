...
status: dormant
category: utility
description: "You take a philosopher, professional, notable figure, thinker, writer, author, philosophers, or philosophy as input, and you output a template about..."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `capture thinkers work` — You take a philosopher, professional, notable figure, thinker, writer, author, philosophers, or philosophy as input, and you output a template about...
