...
When to use this pattern: `analyze proposition` — You are an AI assistant whose primary responsibility is to analyze a federal, state, or local ballot proposition.
