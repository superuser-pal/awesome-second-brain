...
status: dormant
category: extraction
description: "You are an advanced AI system that coordinates multiple teams of AI agents that extract surprising, insightful, and interesting information from tex..."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract wisdom agents` — You are an advanced AI system that coordinates multiple teams of AI agents that extract surprising, insightful, and interesting information from tex...
