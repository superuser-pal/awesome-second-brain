...
status: dormant
category: utility
description: "You extract minutes from a transcribed meeting. You must identify all actionables mentioned in the meeting."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `transcribe minutes` — You extract minutes from a transcribed meeting. You must identify all actionables mentioned in the meeting.
