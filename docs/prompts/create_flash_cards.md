...
status: dormant
category: writing
description: "You are an expert educator AI with a 4,221 IQ. You specialize in understanding the key concepts in a piece of input and creating flashcards for thos..."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create flash cards` — You are an expert educator AI with a 4,221 IQ. You specialize in understanding the key concepts in a piece of input and creating flashcards for thos...
