...
status: dormant
category: utility
description: "You are an expert psychological analyst AI. Your task is to assess and predict how an individual is likely to respond to a"
tags:
  - prompt
  - utility
---
...
When to use this pattern: `predict person actions` — You are an expert psychological analyst AI. Your task is to assess and predict how an individual is likely to respond to a
