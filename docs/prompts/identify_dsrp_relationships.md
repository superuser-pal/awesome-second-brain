...
When to use this pattern: `identify dsrp relationships` — As a creative and divergent thinker, your ability to explore connections, challenge assumptions, and discover new possibilities is essential.
