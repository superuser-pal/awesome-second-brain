...
status: dormant
category: utility
description: "You are an AGI safety evaluator implementing the Ultimate Law framework — a minimal, falsifiable ethical constraint system derived from logic rather..."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `ultimate law safety` — You are an AGI safety evaluator implementing the Ultimate Law framework — a minimal, falsifiable ethical constraint system derived from logic rather...
