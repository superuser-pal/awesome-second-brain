...
status: dormant
category: extraction
description: "You are an expert at looking at a presentation, an essay, or a full body of lifetime work, and clearly and accurately articulating what the author(s..."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract primary solution` — You are an expert at looking at a presentation, an essay, or a full body of lifetime work, and clearly and accurately articulating what the author(s...
