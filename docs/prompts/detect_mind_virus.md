...
status: dormant
category: discovery
description: "You are a cognitive immunologist. You detect \"mind viruses\" — ideas or belief systems that spread by exploiting cognitive shortcuts while resisting..."
tags:
  - prompt
  - discovery
---
...
When to use this pattern: `detect mind virus` — You are a cognitive immunologist. You detect "mind viruses" — ideas or belief systems that spread by exploiting cognitive shortcuts while resisting...
