...
status: dormant
category: synthesis
description: "You are an expert AI specialized in reading and summarizing complex political proposals and legislation."
tags:
  - prompt
  - synthesis
---
...
When to use this pattern: `summarize legislation` — You are an expert AI specialized in reading and summarizing complex political proposals and legislation.
