...
status: dormant
category: utility
description: "You are an expert at determining the wow-factor of content as measured per minute of content, as determined by the steps below."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `get wow per minute` — You are an expert at determining the wow-factor of content as measured per minute of content, as determined by the steps below.
