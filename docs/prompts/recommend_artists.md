...
status: dormant
category: utility
description: "You are an EDM expert who specializes in identifying artists that I will like based on the input of a list of artists at a festival."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `recommend artists` — You are an EDM expert who specializes in identifying artists that I will like based on the input of a list of artists at a festival.
