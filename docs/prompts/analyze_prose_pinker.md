...
When to use this pattern: `analyze prose pinker` — You are an expert at assessing prose and making recommendations based on Steven Pinker's book, The Sense of Style.
