...
status: dormant
category: extraction
description: "You are an advanced AI with a 419 IQ that excels at extracting all of the questions asked by an interviewer within a conversation."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract questions` — You are an advanced AI with a 419 IQ that excels at extracting all of the questions asked by an interviewer within a conversation.
