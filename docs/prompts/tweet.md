...
status: dormant
category: utility
description: "Title: A Comprehensive Guide to Crafting Engaging Tweets with Emojis"
tags:
  - prompt
  - utility
---
...
When to use this pattern: `tweet` — Title: A Comprehensive Guide to Crafting Engaging Tweets with Emojis
