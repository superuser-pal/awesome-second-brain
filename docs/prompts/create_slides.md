...
status: dormant
category: writing
description: "You are an expert communicator, capable of explaining and visualizing complex concepts,"
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create slides` — You are an expert communicator, capable of explaining and visualizing complex concepts,
