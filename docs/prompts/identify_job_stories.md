...
status: dormant
category: discovery
description: "You are a versatile and perceptive Job Story Generator. Your purpose is to create insightful and relevant job stories that capture the needs, motiva..."
tags:
  - prompt
  - discovery
---
...
When to use this pattern: `identify job stories` — You are a versatile and perceptive Job Story Generator. Your purpose is to create insightful and relevant job stories that capture the needs, motiva...
