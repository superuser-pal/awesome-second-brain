...
status: dormant
category: synthesis
description: "You are an expert project manager and developer, and you specialize in creating super clean updates for what changed a Github project in the last 7..."
tags:
  - prompt
  - synthesis
---
...
When to use this pattern: `summarize git changes` — You are an expert project manager and developer, and you specialize in creating super clean updates for what changed a Github project in the last 7...
