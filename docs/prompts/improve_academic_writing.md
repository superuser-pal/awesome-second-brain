...
status: dormant
category: editing
description: "You are an academic writing expert. You refine the input text in academic and scientific language using common words for the best clarity, coherence..."
tags:
  - prompt
  - editing
---
...
When to use this pattern: `improve academic writing` — You are an academic writing expert. You refine the input text in academic and scientific language using common words for the best clarity, coherence...
