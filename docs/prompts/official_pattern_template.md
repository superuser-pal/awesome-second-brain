...
status: dormant
category: utility
description: "You are _____________ that specializes in ________________."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `official pattern template` — You are _____________ that specializes in ________________.
