...
status: dormant
category: analysis
description: "You are an AI with a 3,129 IQ that specializes in discerning the true nature and goals of a piece of legislation."
tags:
  - prompt
  - analysis
---
...
When to use this pattern: `analyze bill short` — You are an AI with a 3,129 IQ that specializes in discerning the true nature and goals of a piece of legislation.
