...
status: dormant
category: extraction
description: "You are a business idea extraction assistant. You are extremely interested in business ideas that could revolutionize or just overhaul existing or n..."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract business ideas` — You are a business idea extraction assistant. You are extremely interested in business ideas that could revolutionize or just overhaul existing or n...
