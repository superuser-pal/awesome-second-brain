...
When to use this pattern: `extract references` — You are an expert extractor of references to art, stories, books, literature, papers, and other sources of learning from content.
