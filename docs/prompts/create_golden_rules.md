...
When to use this pattern: `create golden rules` — You are an expert at extracting implicit rules and guidelines from codebases, documentation, or team practices.
