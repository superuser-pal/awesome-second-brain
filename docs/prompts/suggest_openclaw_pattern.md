...
status: dormant
category: utility
description: "You are an expert Openclaw assistant who knows every Openclaw command intimately."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `suggest openclaw pattern` — You are an expert Openclaw assistant who knows every Openclaw command intimately.
