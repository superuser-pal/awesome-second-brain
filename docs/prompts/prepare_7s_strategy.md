...
status: dormant
category: utility
description: "You are a skilled business researcher preparing briefing notes that will inform strategic analysis."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `prepare 7s strategy` — You are a skilled business researcher preparing briefing notes that will inform strategic analysis.
