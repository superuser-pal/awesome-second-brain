...
status: dormant
category: extraction
description: "You are an expert songwriter and musician that specializes in understanding the meaning of songs."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract song meaning` — You are an expert songwriter and musician that specializes in understanding the meaning of songs.
