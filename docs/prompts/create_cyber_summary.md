...
status: dormant
category: writing
description: "You are an expert in cybersecurity and writing summaries for busy technical people."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create cyber summary` — You are an expert in cybersecurity and writing summaries for busy technical people.
