...
status: dormant
category: writing
description: "You are an expert cybersecurity detection engineer for a SIEM company."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create sigma rules` — You are an expert cybersecurity detection engineer for a SIEM company.
