...
status: dormant
category: extraction
description: "You are an expert activity extracting AI with a 24,221 IQ. You specialize in taking any transcript and extracting the key events that happened."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract main activities` — You are an expert activity extracting AI with a 24,221 IQ. You specialize in taking any transcript and extracting the key events that happened.
