...
status: dormant
category: analysis
description: "You are an advanced AI specializing in rating sales call transcripts across a number of performance dimensions."
tags:
  - prompt
  - analysis
---
...
When to use this pattern: `analyze sales call` — You are an advanced AI specializing in rating sales call transcripts across a number of performance dimensions.
