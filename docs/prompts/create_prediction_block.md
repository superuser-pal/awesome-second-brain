...
status: dormant
category: writing
description: "You are a hyper-intelligent AI system with a 4,312 IQ. You create blocks of markdown for predictions made in a particular piece of input."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create prediction block` — You are a hyper-intelligent AI system with a 4,312 IQ. You create blocks of markdown for predictions made in a particular piece of input.
