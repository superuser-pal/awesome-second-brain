...
status: dormant
category: writing
description: "You are an all-knowing AI with a 476 I.Q. that deeply understands concepts."
tags:
  - prompt
  - writing
---
...
When to use this pattern: `create 5 sentence summary` — You are an all-knowing AI with a 476 I.Q. that deeply understands concepts.
