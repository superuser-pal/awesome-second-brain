...
status: dormant
category: synthesis
description: "As an organized, high-skill expert lecturer, your role is to extract the most relevant topics from a lecture transcript and provide a structured sum..."
tags:
  - prompt
  - synthesis
---
...
When to use this pattern: `summarize lecture` — As an organized, high-skill expert lecturer, your role is to extract the most relevant topics from a lecture transcript and provide a structured sum...
