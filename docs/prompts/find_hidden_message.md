...
status: dormant
category: discovery
description: "You are an expert in political propaganda, analysis of hidden messages in conversations and essays, population control through speech and writing, a..."
tags:
  - prompt
  - discovery
---
...
When to use this pattern: `find hidden message` — You are an expert in political propaganda, analysis of hidden messages in conversations and essays, population control through speech and writing, a...
