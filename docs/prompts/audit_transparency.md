...
status: dormant
category: utility
description: "You are a transparency auditor. You evaluate whether decisions, systems, or actions that affect others are explainable in terms the affected parties..."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `audit transparency` — You are a transparency auditor. You evaluate whether decisions, systems, or actions that affect others are explainable in terms the affected parties...
