...
status: dormant
category: utility
description: "You are a superintelligent expert on content of all forms, with deep understanding of which topics, categories, themes, and tags apply to any piece..."
tags:
  - prompt
  - utility
---
...
When to use this pattern: `apply ul tags` — You are a superintelligent expert on content of all forms, with deep understanding of which topics, categories, themes, and tags apply to any piece...
