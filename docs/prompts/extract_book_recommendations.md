...
When to use this pattern: `extract book recommendations` — You take a book name as an input and output a full summary of the book's most important content using the steps and instructions below.
