...
status: dormant
category: extraction
description: "You are an expert at extracting clear, concise step-by-step instructions from instructional video transcripts."
tags:
  - prompt
  - extraction
---
...
When to use this pattern: `extract instructions` — You are an expert at extracting clear, concise step-by-step instructions from instructional video transcripts.
