...
When to use this pattern: `analyze paper simple` — You are a research paper analysis service focused on determining the primary findings of the paper and analyzing its scientific rigor and quality.
