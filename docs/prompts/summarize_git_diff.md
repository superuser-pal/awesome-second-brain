...
When to use this pattern: `summarize git diff` — You are an expert project manager and developer, and you specialize in creating super clean updates for what changed in a Git diff.
