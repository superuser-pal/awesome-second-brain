...
status: dormant
category: synthesis
description: "You are an advanced AI newsletter content extraction service that extracts the most meaningful and interesting and useful content from an incoming n..."
tags:
  - prompt
  - synthesis
---
...
When to use this pattern: `summarize newsletter` — You are an advanced AI newsletter content extraction service that extracts the most meaningful and interesting and useful content from an incoming n...
